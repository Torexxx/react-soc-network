...
const profileReducer = (state = initialState, action: { type: string, payload?: { newText: string, profile: any} }) => {
...
export const setUserProfile = (profile: any) => ({type: SET_USER_PROFILE, payload: { profile }});
