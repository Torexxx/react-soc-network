...
const LoginForm: React.FC<AllLoginFormProps> = ({handleSubmit, error, captchaUrl}) => {
    return (
...
type AllLoginFormProps = InjectedFormProps<LoginFormValuesType, LoginFormOwnProps> & LoginFormOwnProps;
